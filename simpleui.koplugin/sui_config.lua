...
M.ICON = {
    ...
    tags           = _P .. "tags.svg",
    added          = _P .. "added.svg",
    publication    = _P .. "publication.svg",
...
M.ALL_ACTIONS = {
    ...
    { id = "browse_added",     label = _("Date Added"),       icon = M.ICON.added,
      browsemeta_mode = "added" },
    { id = "browse_publication", label = _("Publication Date"), icon = M.ICON.publication,
