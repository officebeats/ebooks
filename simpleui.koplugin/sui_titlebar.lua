                    ...
                    callback = function()
                        ...
                        dlg = ButtonDialog:new{
                            ...
                            buttons = {
                                ...
                                {{ text = _check("added")       .. _("By date added"),        callback = function() _navigate(dlg, "added")       end }},
                                {{ text = _check("publication") .. _("By publication date"),  callback = function() _navigate(dlg, "publication") end }},
